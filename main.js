...
let MSGame = (function(){
    ...
    class _MSGame {
        constructor(rows, cols, mines) {
            this.init(rows, cols, mines); // easy
        }
...
function cardRichtClicked(game, card, row, col) {
    console.log("card clicked!  ", card.dataset.position);
}
...
function renderBoard(game) {
    ...
    console.log(gridWrapper.width, gridWrapper.height);
    grid.innerHTML = "";
